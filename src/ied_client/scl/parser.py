"""SCL parser: ``load_scl()`` turns an SCL file into an :class:`~ied_client.scl.model.SclDocument`.
...
* Missing optional attributes get their schema defaults. Anything merely odd (unparseable
  ...
  :class:`~ied_client.scl.errors.SclError`. Dangling type references raise later, in
  :func:`~ied_client.scl.expand.expand_server`, when the model actually needs them.
